...
pipedrive_api_cursor_advance_total = Counter("pipedrive_api_cursor_advance_total", "Total number of API cursor advances performed in V2 endpoints", ["endpoint"])
pipedrive_api_breaker_open_total = Counter("pipedrive_api_breaker_open_total", "Total number of times CircuitBreaker was opened for Pipedrive API")
...
etl_uptime_seconds = Gauge("etl_uptime_seconds", "Uptime of the ETL main process in seconds")
...
api_request_duration_hist = Histogram("pipedrive_api_request_duration_seconds", "Pipedrive API request durations", ["endpoint", "method", "status_code"], buckets=[0.01, 0.05, 0.1, 0.5, 1, 2, 5, 10, 20, 30, 60])
